...
res = requests.post(f"{base_url}/user", params=user).json()
uid = int(res["uid"])
print(">>>", res, "\n")
...
print(">>>", requests.put(f"{base_url}/user/{uid}", params=user).text, "\n")


print("5.3", "Delete a user")
print(">>>", requests.delete(f"{base_url}/user/{uid}").text, "\n")
